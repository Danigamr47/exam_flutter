...
class _TransportScreenState extends State<TransportScreen> {
  ...
  final List<Map<String, dynamic>> transportServices = const [
    ...
    {"name": "DEM DIKK", "icon": Icons.directions_bus_filled, "color": Colors.orange},
      ...
      builder: (ctx) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("Ticket détecté : ${data['service']}", style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            const SizedBox(height: 8),
            Text("Référence : ${data['reference']}"),
            Text("Montant : ${_currencyFormat.format(data['amount'])}", style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.pop(ctx);
                  _processPayment(data['service'], data['reference'], data['amount']);
                },
  ...
  Future<void> _processPayment(String service, String reference, double amount) async {
    ...
    if (auth.verifyPin(enteredPin)) {
      ...
      if (success) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text("Paiement $service de ${_currencyFormat.format(amount)} réussi !"),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: const Text("Scanner un ticket", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
      ),
      body: Column(
        children: [
          const Padding(
